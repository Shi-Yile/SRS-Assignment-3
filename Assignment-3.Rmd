...
In this section, we introduce the methodologies of the kernel density estimation and its competitors first. Next, we run one-shot experiments and construct density plots to compare the performances of density estimation methods, after data generating processes.

### 2.1 Methodology

**Kernel Density Estimation**
  
The kernel density estimation (KDE) is a widely-used density estimator, which centres a smooth kernel function at each data point then summing to get a density estimate [@deng2011density]. 
